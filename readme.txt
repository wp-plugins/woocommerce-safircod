...
Plugin get shipping cost from SafirCOD, an Iranian Cash on Delivery service which support shipping over country, and then register shop order(s) in this system. 
...
برای دانستن چگونگی نصب افزونه، سربرگ [Installation](http://wordpress.org/extend/plugins/woocommerce-safircod/installation/) را مطالعه کنید. همچنین فایل راهنمای نصب با فرمت PDF ، در بسته‌ی دانلودی در دسترس است، در این فایل مراحل تنظیم و راه‌اندازی افزونه به کمک تصاویری توضیح داده شده است.
